...
const DragCloseDrawer = () => {
  ...
  return (
    <div className="grid h-screen place-content-center bg-neutral-950">
      ...
      <DragDrawer open={open} setOpen={setOpen}>
...
const DragDrawer = ({ open, setOpen, children }: Props) => {
    ...
    <>
      {open && (
        ...
        >
          ...
          >
            <div className="flex justify-center bg-neutral-900 p-4 left-0 right-0 top-0 z-10 absolute">
              <button
                onPointerDown={(e) => {
                  controls.start(e);
                }}
